...
void userMain() {
    ...
    switch (test) {
        case 1:
            ...
            break;
        case 2:
#if LEVEL_2_IMPLEMENTED == 1 //cpp api - if run redefined, but also constructor with function called from original function, make run or constructor just point to function (ignore run)
